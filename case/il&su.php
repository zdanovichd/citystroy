...
<style>
	...
	.menu-mob_main > li:nth-child(6) > a {
		...
		<article>
			...
			<img class="case__cover-mob" src="../assets/img/cart/IL_&_sushi/1.jpg.webp" alt="" loading="lazy">
			...
			<div id="case__about" class="case__about">
				...
				<div class="case__about-title">
					...
					<p class="h2"><span>Объект:</span> Ресторан <br>
							...
							<span>Срок реализации проекта:</span> 116 дней</p>
			...
			<div class="case__report">
				...
				<div class="case__report-point">
					...
					<p class="h2">Кроме СМР и работ субподрядчиков мы укомплектовали объект компьютерно-кассовым и слаботочным оборудованием, смонтировали и произвели пусконаладочные работы со специалистами компании правообладателем бренда.</p>
				</div>

				<div class="case__report-point">
					<p class="h1">Сервисное обслуживание</p>
					<p class="h2">Мы выполняли сервисное обслуживание в течение двух лет. На данный момент ресторан находится на постгарантийном обслуживании.</p>
				</div>
			</div>
		...
		<div class="case__swiper-con">
			<div class="swiper case__swiper">
				<div class="swiper-wrapper">
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/IL_&_sushi/1.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/IL_&_sushi/2.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/IL_&_sushi/3.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/IL_&_sushi/4.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/IL_&_sushi/5.jpg.webp"/ alt="" loading="lazy"></div>
				</div>
			...
			<div thumbsSlider="" class="swiper case__swiper-2">
				<div class="swiper-wrapper">
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/IL_&_sushi/1.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/IL_&_sushi/2.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/IL_&_sushi/3.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/IL_&_sushi/4.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/IL_&_sushi/5.jpg.webp"/ alt="" loading="lazy"></div>
				</div>
			</div>
