...
<style>
	...
	.menu-mob_main > li:nth-child(6) > a {
		...
		<article>
			...
			<img class="case__cover-mob" src="../assets/img/cart/costa/8.jpg.webp" alt="" loading="lazy">
			...
			<div id="case__about" class="case__about">
				...
				<div class="case__about-title">
					...
					<p class="h2"><span>Объект:</span> Кофейня <br>
							<span>Локация:</span> ТРЦ Ривьера <br>
							<span>Площадь объекта:</span> 250 м2 <br>
		...
		<div class="case__swiper-con">
			<div class="swiper case__swiper">
				<div class="swiper-wrapper">
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/costa/1.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/costa/2.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/costa/3.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/costa/4.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/costa/5.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/costa/6.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/costa/7.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/costa/8.jpg.webp"/ alt="" loading="lazy"></div>
				</div>
			...
			<div thumbsSlider="" class="swiper case__swiper-2">
				<div class="swiper-wrapper">
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/costa/1.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/costa/2.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/costa/3.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/costa/4.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/costa/5.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/costa/6.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/costa/7.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/costa/8.jpg.webp"/ alt="" loading="lazy"></div>
				</div>
			</div>
