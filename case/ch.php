		...
		<div class="case__title">
			...
			<div class="swiper case__swiper">
				<div class="swiper-wrapper">
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/ch/1.jpg"/ alt=""></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/ch/2.jpg"/ alt=""></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/ch/3.jpg"/ alt=""></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/ch/4.jpg"/ alt=""></div>
			...
			<div thumbsSlider="" class="swiper case__swiper-2">
				<div class="swiper-wrapper">
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/ch/1.jpg"/ alt=""></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/ch/2.jpg"/ alt=""></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/ch/3.jpg"/ alt=""></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/ch/4.jpg"/ alt=""></div>
