...
<!-- HEAD -->
<head>
    <title> Наши партнеры | Ситистрой</title>
    <meta name="description" content="
        Ситистрой сотрудничает с проверенными поставщиками материалов,
        производителями мебели, инженерными компаниями и дизайнерскими студиями.
        Вместе мы создаем качественные и долговечные решения для коммерческих помещений.
    ">
    <?php
...
<div class="policy">
    ...
    <div class="swiper ticker">
        <h1 class="ticker__name">Наши партнеры</h1>
