...
<article class="services">
    <div class="services__container">
        ...
        <div class="services__grid">
            ...
            <div class="service__item">
                <h3 class="h2">Инженерные системы</h3>
            ...
            <div class="service__item">
                <h3 class="h2">Отделочные работы</h3>
    ...
    <div class="features__container">
        ...
        <div class="features__content">
            <div class="feature__item">
                <h3 class="h2">Нагрузка на материалы</h3>
            ...
            <div class="feature__item">
                <h3 class="h2">Планировка = прибыль</h3>
            ...
            <div class="feature__item">
                <h3 class="h2">Стиль = лояльность</h3>
...
<article class="zones">
    <div class="zones__container">
        ...
        <div class="zones__grid">
            ...
            <div class="zone__item">
                <h3 class="h2">Веранда / летняя площадка</h3>
            ...
            <div class="zone__item">
                <h3 class="h2">Зона ожидания / холл</h3>
            ...
            <div class="zone__item">
                <h3 class="h2">Зона выдачи / кассовый узел</h3>
