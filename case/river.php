...
<style>
	...
	.menu-mob_main > li:nth-child(6) > a {
		...
		<article>
			...
			<img class="case__cover-mob" src="../assets/img/cart/river/1.jpg.webp" alt="" loading="lazy">
			<div class="case__cover case-river">
			</div>
			...
			<div id="case__about" class="case__about">
				...
				<div class="case__about-title">
					<p class="h1">RIVER ONE</p>
					<p class="h2"><span>Объект:</span> Кальянная <br>
							<span>Локация:</span> ЖК Зил Арт <br>
		...
		<div class="case__swiper-con">
			<div class="swiper case__swiper">
				<div class="swiper-wrapper">
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/river/1.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/river/2.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/river/3.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/river/4.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/river/5.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/river/6.jpg.webp"/ alt="" loading="lazy"></div>
				</div>
			...
			<div thumbsSlider="" class="swiper case__swiper-2">
				<div class="swiper-wrapper">
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/river/1.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/river/2.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/river/3.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/river/4.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/river/5.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/river/6.jpg.webp"/ alt="" loading="lazy"></div>
				</div>
			</div>
