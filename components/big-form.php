            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide slide-cont btnSlide">
                    <form class="big-form" action="#" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-section "><h1 class="form-title">Контактные данные</h1>
                            ...
                            <div class="input-form-ban ">
                                <label class="modal__lab in-cont" for="">Телефон
                                    <input class="modal__input big-tel" type="tel" data-validate-field="tel"
                        ...
                        <div class="form-section"><h1 class="form-title">Что вас интересует?</h1>
                            ...
                            <div class="input-form-ban">
                                <label>
                                    <input name="Что&nbsp;интересует&nbsp;&nbsp;" value="Дизайн интерьера"
                                           type="checkbox"/>
                            ...
                            <div class="input-form-ban">
                                <label>
                                    <input name="Что&nbsp;интересует&nbsp;&nbsp;&nbsp;"
                                           value="Ремонт и строительно-монтажные работы" type="checkbox"/>
                            ...
                            <div class="che input-form-ban">
                                <label>
                                    <input name="Что&nbsp;интересует&nbsp;&nbsp;&nbsp;&nbsp;"
                                           value="Проектирование технологии (кухни)" type="checkbox"/>
                                    <span>Проектирование технологии (кухни)</span>
                                </label>
                            </div>
                            <div class="che input-form-ban">
                                <label>
                                    <input class="input" name="Что&nbsp;интересует&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
                                           value="Инженерное проектирование " type="checkbox"/>
                ...
                <div class="swiper-slide btnSlide">
                    ...
                    <div class="form-section"><h1 class="form-title">Где находится помещение?</h1>
                        ...
                        <div class="input-form-ban">
                            <label>
                                <input name="Местонахождение&nbsp;помещения" value="ТЦ/БЦ" type="radio"/>
                    ...
                    <div class="form-section"><h1 class="form-title">Укажите высоту потолков м&#178</h1>
                        ...
                        <input type="range" class="input-form-ban" id="range-H" value="2.5" step="0.1"
                               name="Высота&nbsp;потолков" min="0" max="5"/>
                    </div>
                ...
                <div class="swiper-slide btnSlide">
                    ...
                    <div class="form-section"><h1 class="form-title">Где территориально расположено помещение?</h1>
                        ...
                        <div class="input-form-ban">
                            <label>
                                <input name="Территориальное&nbsp;расположение" value="Москва, за пределом МКАД"
                                       type="radio"/>
                        ...
                        <div class="input-form-ban">
                            <label>
                                <input name="Территориальное&nbsp;расположение" value="Подмосковье" type="radio"/>
                    ...
                    <div class="form-section"><h1 class="form-title">Какое заведение планируется открыть?</h1>
                        <div class="res-form">
                            <div class="input-form-ban">
                                <label>
                                    <input name="Тип&nbsp;заведения" value="Ресторан" type="radio" checked/>
                                    <span>Ресторан</span>
                                </label>
                            </div>
                            <div class="input-form-ban">
                                <label>
                                    <input name="Тип&nbsp;заведения" value="Бар" type="radio"/>
                                    <span>Бар</span>
                                </label>
                            </div>
                            <div class="input-form-ban">
                                <label>
                                    <input name="Тип&nbsp;заведения" value="Другое" class="over-res" type="radio"/>
                                    <span>Другое</span>
                                </label>
                            </div>
                            <div class="input-form-ban">
                                <label>
                                    <input name="Тип&nbsp;заведения" value="Кальянная" type="radio"/>
                                    <span>Кальянная</span>
                                </label>
                            </div>
                            <div class="input-form-ban">
                                <label>
                                    <input name="Тип&nbsp;заведения" value="Кафе" type="radio"/>
                                    <span>Кафе</span>
                                </label>
                            </div>
                            <div class="input-form-ban">
                                <label>
                                    <input name="Тип&nbsp;заведения" type="text"
                                           class="over-res-in input modal__input input-name"
                    ...
                    <div class="form-section"><h1 class="form-title">Укажите предполагаемое количество посадочных
                        ...
                        <input type="range" class="input-form-ban" id="range-M" value="200"
                               name="Количество&nbsp;посадочных мест" min="0" max="500"/>
                    </div>
                ...
                <div class="swiper-slide SlideEnd btnSlide">
                    ...
                    <div class="form-section"><h1 class="form-title">Заведение планируется открыть по франшизе?</h1>
                        ...
                        <div class="input-form-ban">
                            <label>
                                <input name="Наличие&nbsp;франшизы" value="Нет" type="radio" checked/>
                                <span>Нет</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="form-section"><h1 class="form-title">Какие разделы необходимы в проекте?</h1>
                        ...
                        <div class="input-form-ban">
                            <label>
                                <input name="Необходимые&nbsp;разделы&nbsp;проекта"
                                       value="Спецификация и расстановка технологического оборудования" type="checkbox"
                                       checked/>
                        ...
                        <div class="input-form-ban">
                            <label>
                                <input name="Необходимые&nbsp;разделы&nbsp;проекта&nbsp;"
                                       value="Водоснабжение, канализация, вентиляция, электроснабжение" type="checkbox"
                                       checked/>
                        ...
                        <div class="input-form-ban">
                            <label>
                                <input name="Необходимые&nbsp;разделы&nbsp;проекта&nbsp;&nbsp;"
                                       value="Отделка стен, полов и потолков" type="checkbox" checked/>
            ...
            <span class="error_mes"></span>
                    ...
                    <div class="modal__check-con big-btn-con">
                        ...
                        <label type="checkbox" class="modal__check-text" for="big__check-btn">
                            ...
                            <a href="../pages/assent.php"><img class="modal__check-que" src="/assets/img/icon/que.svg"
                                                               alt=""></a>
                        </label>
