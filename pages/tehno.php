...
?>
		...
		<article id="anchor_title" class="title__con">
				<div class="title">
					<div class="title__text">
						<div>
							<h1 class="h1"> ТЕХНОЛОГИЧЕСКОЕ ПРОЕКТИРОВАНИЕ</h1>
					...
					<p class="h2">
						...
						<!-- <div>
							<p class="h1">ТЕХНОЛОГИЧЕСКОЕ ПРОЕКТИРОВАНИЕ</p>
						</div>
						<p class="h2">
							кухни и зала для ресторанов за 8-10 дней в Москве «под ключ» <br>
							<p>перегородки и стены, спецификация и расстановка оборудования, планировка посадочных мест,<br> планы привязки инженерных коммуникаций</p>
	...
	<!-- SCREEN_2 ABOUT-->
		<article id="teho-about" class="about">
			<p class="h1 about__title">Наши проектировочные решения создают основу окупаемости за счет:</p>

			<div class="about__item teh">
				<p class="h3">
					<img src="/assets/icon/16.svg" alt="" loading="lazy">
				...
				<p class="h3" >
					<img src="/assets/icon/2.svg" alt="" loading="lazy">
						Уменьшения ежемесячных операционных расходов
								...
								<!-- <p class="h3" >
					<img src="/assets/img/icon/teh_5.svg" alt="" loading="lazy">
					Водоснабжение, канализация, вентиляция, электроснабжение
				</p>
				<p class="h3"> -->
				<p class="h3">
					<img src="/assets/icon/19.svg" alt="" loading="lazy">
					<a href="#tehno-plan-con">Нестандартное оборудование</a>
				</p>
				<p class="h3">
					<img src="/assets/icon/17.svg" alt="" loading="lazy">
					Сокращаете количество персонала
				</p>
				<p class="h3" >
					<img src="/assets/icon/8.svg" alt="" loading="lazy">
					Увеличиваете площадь под посадочные места
				</p>
			</div>
			

			<p class="h2 about__column-title teh-span"><span>Технологический проект</span> — основа для успешной работы ресторана</p>
			<p class="h3 about__column-sub-title sub-teh-span">В проекте мы прорабатываем ключевые факторы, влияющие на
			качество кухни, скорость работы персонала и проходимость заведения</p>
			<div class="about__column about__teh teh">

				<div>
					<div>
						<p class="h1 about__column_2 teh-about__column">Оптимально используем пространство помещения</p>
					</div>
					<p class="h3">Применяем оригинальные решения и задействуем при необходимости всю высоту помещения, тем самым увеличиваем общую полезную площадь под размещение посадочных мест</p>
				</div>
				<div>
					<div>
						<p class="h1">Делаем заведение удобным для персонала</p>
					</div>
					<p class="h3">Разрабатываем планировку технологических помещений ресторана с точки зрения оптимального движения потоков продуктов на разных стадиях производства<br>Это делает зону технологии удобной для персонала, увеличивая его эффективность, что сокращает время ожидания заказов и увеличивает проходимость ресторана.</p>
				</div>
				<div>
					<div>
						<p class="h1">Подбираем оборудование для
						оптимизации производственных процессов</p>
					</div>
					<p class="h3">Подбираем технологическое оборудование с учетом кулинарного профиля ресторана, на основе большого опыта взаимодействия с производителями профессионального оборудования</p>
				</div>

				<div>
					<div>
						<p class="h1">Как результат:</p>
					</div>
					<p class="h3">- Вы обслуживаете больше гостей одновременно<br>
			...
			<p class="blue">Ресторан работает лучше и быстрее окупается!</p></p>
		...
		<article>
			...
			<div class="cart-teh сart-teh__mob">
				...
				<div class="title-teh_con">
					<p class="h1 title-teh">Перегородки и стены</p>
					<p class="h2 text-teh">Этот раздел включает в себя план перегородок и внутренних стен здания с подробными размерами и конструктивными особенностями, с указанием проемов, дверей, рольставней и их технических характеристик, экспликацию помещений.</p>
					<ul>
			...
			<div class="cart-teh сart-teh__mob">
				...
				<div class="title-teh_con">
					<p class="h1 title-teh">Спецификация и расстановка технологического оборудования</p>
					<p class="h2 text-teh">Спецификация технологического оборудования содержит подробные технические характеристики, размеры, потребляемые мощности.<br> <br>По запросу Заказчика предложим производителя и марку/тип оборудования. <br><br>
					По заданию Заказчика разрабатываем планировку помещений в соответствии с САНПИН и СНИП, также и подробную схему расстановки оборудования с указанием нумерации по каждой позиции.</p>
					<p class="h3">
			...
			<div class="cart-teh сart-teh__mob">
				...
				<div class="title-teh_con">
					<p class="h1 title-teh">Водоснабжение, канализация, вентиляция, электроснабжение</p>
					<p class="h2 text-teh">В этих разделах будут указаны все расстояния, высоты, габариты, места расположения, способы подвода (отвода) и распределения:</p>
					<ul>
			...
			<div class="cart-teh сart-teh__mob">
				...
				<div class="title-teh_con">
					<p class="h1 title-teh">Технологические потоки</p>
					<p class="h2 text-teh">Составим подробный план технологических потоков, который включает в себя перемещение продуктов, работников кухни, официантов и другого персонала, учитывая количество работников, рабочих смен, времени работы ресторана и количества перемещаемых продуктов в день.</p>
					<p class="h3">
			...
			<div class="cart-teh сart-teh__mob">
				...
				<div class="title-teh_con">
					<p class="h1 title-teh">Отделка стен, полов и потолков</p>
					<p class="h2 text-teh">В данных разделах:</p>
					<ul>
			...
			<div class="cart-teh сart-teh__mob">
				...
				<div class="title-teh_con">
					<p class="h1 title-teh">Нестандартное оборудование</p>
					<p class="h2 text-teh">В случае, если на рынке нет необходимого оборудования, мы выполним эскизные решения нестандартного технологического или иного оборудования, барных и кассовых стоек, используемых на данной точке с подробным описание конструктивных особенностей, используемых материалов, технических и технологических требований.</p>
					<ul>
		...
		<div class="tehno-plan-con" id="tehno-plan-con">
			<div class="tehno-plan">
				<div class="tehno-plan__text">
					<p class="h1">Бесплатно разработаем</p>
					<p class="h2">концепцию кухни для ресторана в Москве от 300м²</p>
					<p class="h3">- план предварительного зонирования: <br>
						...
						- план примернной планировки посадочных мест в зале</p>
				...
				<div class="plan-img-pdf">
					<div class="tehno-plan__img open-pdf">
						<img class="tehno-plan__img__search" src="/assets/img/icon/search.svg" alt="" loading="lazy">
						<img class="tehno-plan__img__main" src="/assets/img/icon/plan.svg" alt="" loading="lazy">
					</div>
			...
			<p class="h1">В результате вы узнаете:</p>
			<div>
				<p class="h3">- какая необходима площадь под технологию и подсобные помещения<br>
				...
				<p class="h3">- какая площадь необходима под зал<br>
		...
		<div class="plan-con">
			<img class="plan-close" src="/assets/img/icon/burger-close.svg" alt="" loading="lazy">
			<div class="plan">
	...
	<div class="video_con">
		...
		<p class="h2 video-title_2"><span>Технолог</span>Наталья Морозова</p>
		<div class="video-block">
			<div class="video_b">
				...
				<p class="h1 video-title_4">О технологии ресторанов, кафе, баров и кальянных Часть 1</p>
