...
<style>
	...
	.menu-mob_main > li:nth-child(6) > a {
		...
		<article>
			...
			<img class="case__cover-mob" src="../assets/img/cart/niama/5.jpg.webp" alt="" loading="lazy">
			<div class="case__cover case-niama_butovo">
			</div>
			...
			<div id="case__about" class="case__about">
				...
				<div class="case__about-title">
					<p class="h1">НИЯМА</p>
					<p class="h2"><span>Объект:</span> Кафе <br>
							<span>Локация:</span> ТЦ Бутово молл <br>
							<span>Площадь объекта:</span> 124 м2 <br>
		...
		<div class="case__swiper-con">
			<div class="swiper case__swiper">
				<div class="swiper-wrapper">
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/niama/1.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/niama/2.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/niama/3.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/niama/4.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/niama/5.jpg.webp"/ alt="" loading="lazy"></div>
				</div>
			...
			<div thumbsSlider="" class="swiper case__swiper-2">
				<div class="swiper-wrapper">
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/niama/1.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/niama/2.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/niama/3.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/niama/4.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/niama/5.jpg.webp"/ alt="" loading="lazy"></div>
				</div>
			</div>
