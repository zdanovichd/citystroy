...
<article class="services">
    <div class="services__container">
        ...
        <p class="h3">Когда вы заказываете у нас ремонт кафе или ремонт ресторана под ключ, вы получаете не просто список строительных работ — вы получаете комплексное решение, учитывающее специфику общественного питания, нагрузки, нормативы и эстетику. Мы не просто меняем обои — мы создаем среду, в которой ваш бизнес будет процветать. Мы берем на себя:</p>
...
<article class="features">
    <div class="features__container">
        ...
        <p class="h3">Ремонт ресторана — это отдельная вселенная. Здесь не работают стандартные схемы из ремонта квартир или офисов. С 2016 года мы  специализируемся на коммерческих объектах — и знаем каждую мелочь, которая может сломать бизнес, если ее не предусмотреть.</p>
        <p class="h3">Вот что отличает отделку ресторанов и отделку кафе от обычных ремонтных работ:</p>
    ...
    <div class="stages__container">
        ...
        <div class="stages__timeline">
            <div class="stage__item">
                ...
                <p class="h3">Мы приезжаем в любое удобное для вас время. Фиксируем габариты, особенности помещения, слушаем ваши пожелания. Это основа будущей сметы — без нее ремонт ресторана может обернуться переделками и переплатами.</p>
            </div>
            <div class="stage__item">
                <p class="h2">Разработка дизайн-проекта и сметы</p>
                <p class="h3">На основе замеров готовим детальный расчет стоимости — без скрытых строк. Если нужно — делаем 3D-визуализацию, подбираем материалы, согласовываем каждую деталь. Смету вы получаете за 1 день — чтобы сразу понимать бюджет.</p>
            </div>
            <div class="stage__item">
                <p class="h2">Подписание договора</p>
                <p class="h3">Фиксируем все: сроки, цену, гарантию, этапы оплаты. Никаких устных обещаний — только четкие условия в договоре. Это ваша защита, если что-то пойдет не по плану. Особенно важно при ремонте кафе в Москве — где сроки критичны.</p>
            </div>
            <div class="stage__item">
                <p class="h2">Демонтаж и подготовка помещения</p>
                <p class="h3">Аккуратно убираем все старое — плитку, полы, перегородки, коммуникации. Сразу вывозим мусор — не оставляем хаос на объекте. При ремонте помещение под ресторан особенно важно: нельзя повредить несущие конструкции или скрытые коммуникации.</p>
            </div>
            <div class="stage__item">
                <p class="h2">Черновые работы и инженерка</p>
                <p class="h3">Самый важный этап — от него зависит, сколько прослужить ваш ремонт. Выравниваем стены и потолки, делаем стяжку, монтируем инженерные коммуникации — вентиляцию, электрику, воду. Все тестируем до чистовой отделки — чтобы потом не долбить стены.</p>
            </div>
            <div class="stage__item">
                <p class="h2">Чистовая отделка и установка</p>
                <p class="h3">Здесь раскрывается стиль: укладываем плитку, красим стены, монтируем потолки, ставим светильники. Работаем строго по дизайн-проекту — цвета, фактуры, текстуры — все, как вы утвердили. При отделке кафе делаем акцент на практичность — чтобы легко мылось и не теряло вид.</p>
            </div>
            <div class="stage__item">
                <p class="h2">Финальная уборка и сдача объекта</p>
                <p class="h3">Моем полы, стекла, протираем все поверхности, вывозим последний мешок мусора. Приглашаем вас на приемку — подписываем акт, передаем ключи, даем гарантию до 3 лет. Ваше заведение — готово к открытию. Без грязи, без пыли, без сюрпризов.</p>
            </div>
        </div>
    </div>
</article>
