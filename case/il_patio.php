...
<style>
	...
	.menu-mob_main > li:nth-child(6) > a {
		...
		<article>
			...
			<img class="case__cover-mob" src="../assets/img/cart/il-pat/1.jpg.webp" alt="" loading="lazy">
			...
			<div class="case__report">
				...
				<div class="case__report-point">
					<p class="h1">Задача</p>
					<p class="h2">Заказчик обратился со своим дизайн-проектом и технологией. Была поставлена задача провести реконструкцию и перепланировку старого ресторана в новый.</p>
				</div>

				<div class="case__report-point">
					<p class="h1">Технические условия</p>
					<p class="h2">Технические условия под задачу реконструкции подходили полностью, так как на этом месте прежде был другой ресторан со схожей концепцией. Необходимо было адаптировать существующие коммуникации под новый проект.</p>
				</div>

				<div class="case__report-point">
					<p class="h1">Инженерные системы</p>
					<p class="h2">Несмотря на то, что технические условия подходили под ресторан, в разрезе поставленной Заказчиком задачи, мы серьезно переделали существующие инженерные коммуникации. Больше всего изменений пришлось на электрическую часть. Новое оборудование располагалось на новых местах, поэтому пришлось двигать все места подключений в горячих и холодных цехах, прокладывать новые линии, глушить старые. Ввиду этого вводной электрический щит пришлось существенно перебрать. По залу изменений было меньше. Используя существующие линии, дизайнеры добавили много висящих светильников на потолке, бра на стены и декоративную подсветку на кашпо.</p>
				</div>

				<div class="case__report-point">
					<p class="h1">СМР</p>
					<p class="h2">Наша компания выполняла все строительно-монтажные работы на объекте. Помимо общестроительных работ, согласно дизайн-проекту, мы сделали:<br>
						<ul>
		...
		<div class="case__swiper-con">
			<div class="swiper case__swiper">
				<div class="swiper-wrapper">
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/il-pat/1.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/il-pat/2.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/il-pat/3.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/il-pat/4.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/il-pat/5.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/il-pat/6.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/il-pat/7.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/il-pat/8.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/il-pat/9.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/il-pat/10.jpg.webp"/ alt="" loading="lazy"></div>
				</div>
			...
			<div thumbsSlider="" class="swiper case__swiper-2">
				<div class="swiper-wrapper">
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/il-pat/1.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/il-pat/2.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/il-pat/3.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/il-pat/4.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/il-pat/5.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/il-pat/6.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/il-pat/7.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/il-pat/8.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/il-pat/9.jpg.webp"/ alt="" loading="lazy"></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/il-pat/10.jpg.webp"/ alt="" loading="lazy"></div>
				</div>
			</div>
