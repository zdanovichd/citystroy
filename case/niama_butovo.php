		...
		<div class="case__swiper-con">
			<div class="swiper case__swiper">
				<div class="swiper-wrapper">
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/niama/1.jpg"/></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/niama/2.jpg"/></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/niama/3.jpg"/></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/niama/4.jpg"/></div>
					<div class="swiper-slide case__slide"><img src="../assets/img/cart/niama/5.jpg"/></div>
				</div>
			...
			<div thumbsSlider="" class="swiper case__swiper-2">
				<div class="swiper-wrapper">
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/niama/1.jpg"/></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/niama/2.jpg"/></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/niama/3.jpg"/></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/niama/4.jpg"/></div>
					<div class="swiper-slide case__slide-2"><img src="../assets/img/cart/niama/5.jpg"/></div>
				</div>
			</div>
