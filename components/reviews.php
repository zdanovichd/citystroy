<section class="reviews" itemscope itemtype="https://schema.org/ItemList">
        <div class="reviews__header">
            <h2 class="h2 reviews__title" itemprop="name">Отзывы</h2>
            <p class="h3 reviews__subtitle">Узнайте, что говорят о нас люди, которые уже воспользовались нашими услугами</p>
        </div>
        ...
        <div class="reviews__slider">
            ...
            <div class="swiper reviews__swiper">
                ...
                <div class="swiper-wrapper">
                    <!-- Slides -->
                    <div class="swiper-slide" itemprop="itemListElement" itemscope itemtype="https://schema.org/Review">
                        <article class="review">
                            <div class="review__header">
                                <div class="review__info">
                                    ...
                                    <p class="review__author-position" itemprop="worksFor" itemscope itemtype="https://schema.org/Organization">
                                        <span itemprop="name">Владелец кофейни в центре Москвы</span>
                                    </p>
                                </div>
                        ...
                        <article class="review">
                            <div class="review__header">
                                <div class="review__info">
                                    ...
                                    <p class="review__author-position" itemprop="worksFor" itemscope itemtype="https://schema.org/Organization">
                                        <span itemprop="name">Управляющий фитнес-клубом в Бутово</span>
                                    </p>
                                </div>
                                <div class="review__rating" itemprop="reviewRating" itemscope itemtype="https://schema.org/Rating">
                                    <meta itemprop="ratingValue" content="5">
                        ...
                        <article class="review">
                            <div class="review__header">
                                <div class="review__info">
                                    ...
                                    <p class="review__author-position" itemprop="worksFor" itemscope itemtype="https://schema.org/Organization">
                                        <span itemprop="name">Директор боулинг-центра в Марьино</span>
                                    </p>
                                </div>
                                <div class="review__rating" itemprop="reviewRating" itemscope itemtype="https://schema.org/Rating">
                                    <meta itemprop="ratingValue" content="5">
                        ...
                        <article class="review">
                            <div class="review__header">
                                <div class="review__info">
                                    ...
                                    <p class="review__author-position" itemprop="worksFor" itemscope itemtype="https://schema.org/Organization">
                                        <span itemprop="name">Запускал грузинское кафе в районе ВДНХ</span>
                                    </p>
                                </div>
                                <div class="review__rating" itemprop="reviewRating" itemscope itemtype="https://schema.org/Rating">
                                    <meta itemprop="ratingValue" content="5">
                        ...
                        <article class="review">
                            <div class="review__header">
                                <div class="review__info">
                                    ...
                                    <p class="review__author-position" itemprop="worksFor" itemscope itemtype="https://schema.org/Organization">
                                        <span itemprop="name">Открыл бургерную на Варшавке</span>
                                    </p>
                                </div>
                                <div class="review__rating" itemprop="reviewRating" itemscope itemtype="https://schema.org/Rating">
                                    <meta itemprop="ratingValue" content="5">
                        ...
                        <article class="review">
                            <div class="review__header">
                                <div class="review__info">
                                    ...
                                    <p class="review__author-position" itemprop="worksFor" itemscope itemtype="https://schema.org/Organization">
                                        <span itemprop="name">Открыла минимаркет у метро «Бабушкинская»</span>
                                    </p>
                                </div>
                                <div class="review__rating" itemprop="reviewRating" itemscope itemtype="https://schema.org/Rating">
                                    <meta itemprop="ratingValue" content="5">
