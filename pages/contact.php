...
<article class="recvis_con" id="recvis_con">
    ...
    <div class="recvis_ recL">
        <div class="recvis_back">
            <div class="recvis-main_title">
                <p class="h1">Реквизиты ООО «СитиСтрой»</p>
            </div>
            ...
            <div class="recvis_main">
                <div class="recvis_main_1">
                    <div class="recvis">
                        <div class="recvis_title">
                            <p class="h1">Полное наименование фирмы:</p>
                            <p class="h2  id="text">Общество с ограниченной <br> ответственностью «СитиСтрой»</p>
                        </div>
                        <div id="copy" class="recvis_copy">
                            ...
                            <p class="h3">Скопировано</p>
                        </div>
                    </div>

                    <div class="recvis">
                        <div class="recvis_title">
                            <p class="h1">Директор:</p>
                            <p class="h2  id="text2">Богдан Сергей Зосимович</p>
                        </div>
                    ...
                    <div class="recvis">
                        <div class="recvis_title">
                            ...
                            <p class="h2">121087 <br>г. Москва, Береговой проезд, д.7, офис 3</p>
                        </div>
                        <div class="recvis_copy">
                            <svg width="44" height="50" viewBox="0 0 44 50" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="recvis">
                        <div class="recvis_title">
                            <p class="h1">Расчётный счёт:</p>
                            <p class="h2">40702810038000029979</p>
                        </div>
                        <div class="recvis_copy">
                            <svg width="44" height="50" viewBox="0 0 44 50" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="recvis_main_2">
                    ...
                    <div class="recvis">
                        <div class="recvis_title">
                            <p class="h1">Корреспондентский счёт:</p>
                            <p class="h2">30101810038000000225</p>
                        </div>
                        <div class="recvis_copy">
                            <svg width="44" height="50" viewBox="0 0 44 50" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="recvis_ recR">
        ...
        <div class="recvis">
            <div class="recvis_title">
                <p class="h1">Адрес:</p>
                <p class="h2">г. Москва, Береговой проезд, д. 7<br>
                    Пн-Сб: с 9-00 до 21-00 Вс - выходной</p>
            </div>
            <div class="recvis_copy">
        ...
        <div class="recvis">
            <div class="recvis_title">
                <p class="h1">Телефон:</p>
                <p class="h2">+7 (926) 363-42-78<br>
                    +7 (495) 109-29-96</p>
            </div>
            <div class="recvis_copy">
                <svg width="44" height="50" viewBox="0 0 44 50" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="recvis">
            <div class="recvis_title">
                <p class="h1">E-mail:</p>
                <p class="h2">csfitout@gmail.com<br>
                    office@citystroy-restaurants.ru</p>
            </div>
            <div class="recvis_copy">
                <svg width="44" height="50" viewBox="0 0 44 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10.796 11.8314L10.8179 7.44423C10.8344 4.14223 13.5158 1.47412 16.8178 1.47412H36.7373C40.051 1.47412 42.7373 4.16041 42.7373 7.47412V31.979C42.7373 35.2927 40.051 37.979 36.7373 37.979H33.2842M7.39453 48.3363H27.2842C30.5979 48.3363 33.2842 45.65 33.2842 42.3363V17.8314C33.2842 14.5177 30.5979 11.8314 27.2842 11.8314H7.39453C4.08082 11.8314 1.39453 14.5177 1.39453 17.8314V42.3363C1.39453 45.65 4.08082 48.3363 7.39453 48.3363Z"
        ...
        <div class="recvis">
            <div class="recvis_title">
                <a href="#"><p class="h1">Политика конфиденциальности</p></a>
            </div>
        </div>
    </div>
